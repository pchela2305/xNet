    ...
    public abstract class ProxyClient : IEquatable<ProxyClient>
    {
            ...
            {   
                ...
                if (value != null && value.Length > 255)
                {
                    throw new ArgumentOutOfRangeException("Username", string.Format(
                        "The length of line must not be more than {0} characters.", 255));
                }
        ...
        protected TcpClient CreateConnectionToProxy()
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    throw NewProxyException("Unable to connect to the proxy server '{0}'.", ex);
                }
            ...
            {
                tcpClient.Close();
                throw NewProxyException("It turned out the wait time to connect to the proxy server '{0}'.");
            }
            ...
            if (connectException != null)
            {
                ...
                {
                    throw NewProxyException("Unable to connect to the proxy server '{0}'.", connectException);
                }
                else
                {
            ...
            {
                tcpClient.Close();
                throw NewProxyException("Unable to connect to the proxy server '{0}'.");
            }
